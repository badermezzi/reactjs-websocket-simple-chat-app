...
- **Format (JSON Text Message):**
  ...
  ```
- **Description:** Broadcast to all _other_ connected clients when a user establishes their first WebSocket connection.
...
- **Format (JSON Text Message):**
  ...
  ```
- **Description:** Broadcast to all _remaining_ connected clients when a user disconnects their last WebSocket connection.
